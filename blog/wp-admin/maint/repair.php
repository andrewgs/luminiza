...
?>
	<p class="step"><a class="button" href="<?=wp_nonce_url('repair.php?repair=1', 'repair_db') ?>"><?php _e( 'Repair Database' );?></a></p>
	...
	<p class="step"><a class="button" href="<?=wp_nonce_url('repair.php?repair=2', 'repair_db') ?>"><?php _e( 'Repair and Optimize Database' );?></a></p>
<?php
}
?>
</body>
