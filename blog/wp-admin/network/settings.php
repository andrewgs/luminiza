	...
	<form method="post" action="edit.php?action=siteoptions">
		...
		<table class="form-table">
			<tr valign="top">
				...
				<td>
					<input name="site_name" type="text" id="site_name" class="regular-text" value="<?=esc_attr( $current_site->site_name ) ?>" />
					<br />
			...
			<tr valign="top">
				...
				<td>
					<input name="admin_email" type="text" id="admin_email" class="regular-text" value="<?=esc_attr( get_site_option('admin_email') ) ?>" />
					<br />
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td>
					<input name="illegal_names" type="text" id="illegal_names" class="large-text" value="<?=esc_attr( implode( " ", (array) get_site_option( 'illegal_names' ) ) );?>" size="45" />
					<br />
...
<?=esc_textarea( $limited_email_domains == '' ? '' : implode( "\n", (array) $limited_email_domains ) );?></textarea>
					<br />
...
<?=esc_textarea( get_site_option( 'banned_email_domains' ) == '' ? '' : implode( "\n", (array) get_site_option( 'banned_email_domains' ) ) );?></textarea>
					<br />
...
<?=esc_textarea( stripslashes( get_site_option( 'welcome_email' ) ) ) ?></textarea>
					<br />
...
<?=esc_textarea( stripslashes( get_site_option( 'welcome_user_email' ) ) ) ?></textarea>
					<br />
...
<?=esc_textarea( stripslashes( get_site_option( 'first_post' ) ) ) ?></textarea>
					<br />
...
<?=esc_textarea( stripslashes( get_site_option('first_page') ) ) ?></textarea>
					<br />
...
<?=esc_textarea( stripslashes( get_site_option('first_comment') ) ) ?></textarea>
					<br />
			...
			<tr valign="top">
				...
				<td>
					<input type="text" size="40" name="first_comment_author" id="first_comment_author" value="<?=get_site_option('first_comment_author') ?>" />
					<br />
			...
			<tr valign="top">
				...
				<td>
					<input type="text" size="40" name="first_comment_url" id="first_comment_url" value="<?=esc_attr( get_site_option( 'first_comment_url' ) ) ?>" />
					<br />
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td><input name="upload_filetypes" type="text" id="upload_filetypes" class="large-text" value="<?=esc_attr( get_site_option('upload_filetypes', 'jpg jpeg png gif') ) ?>" size="45" /></td>
			</tr>
