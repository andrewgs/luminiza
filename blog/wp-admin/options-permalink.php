...
<table class="form-table">
	<tr>
		...
		<td><code><?=get_option('home');?>/?p=123</code></td>
	</tr>
	<tr>
		<th><label><input name="selection" type="radio" value="<?=esc_attr($structures[1]);?>" class="tog" <?php checked($structures[1], $permalink_structure);?> /> <?php _e('Day and name');?></label></th>
		<td><code><?=get_option('home') . $blog_prefix . $prefix . '/' . date('Y') . '/' . date('m') . '/' . date('d') . '/sample-post/';?></code></td>
	</tr>
	<tr>
		<th><label><input name="selection" type="radio" value="<?=esc_attr($structures[2]);?>" class="tog" <?php checked($structures[2], $permalink_structure);?> /> <?php _e('Month and name');?></label></th>
		<td><code><?=get_option('home') . $blog_prefix . $prefix . '/' . date('Y') . '/' . date('m') . '/sample-post/';?></code></td>
	</tr>
	<tr>
		<th><label><input name="selection" type="radio" value="<?=esc_attr($structures[3]);?>" class="tog" <?php checked($structures[3], $permalink_structure);?> /> <?php _e('Numeric');?></label></th>
		<td><code><?=get_option('home') . $blog_prefix . $prefix;?>/archives/123</code></td>
	</tr>
	<tr>
		<th>
		...
		<td>
			<?=$blog_prefix;?>
			<input name="permalink_structure" id="permalink_structure" type="text" value="<?=esc_attr($permalink_structure);?>" class="regular-text code" />
		</td>
	</tr>
</table>
...
<table class="form-table">
	<tr>
		...
		<td><?=$blog_prefix;?> <input name="category_base" id="category_base" type="text" value="<?=esc_attr( $category_base );?>" class="regular-text code" /></td>
	</tr>
	<tr>
		<th><label for="tag_base"><?php _e('Tag base');?></label></th>
		<td><?=$blog_prefix;?> <input name="tag_base" id="tag_base" type="text" value="<?=esc_attr($tag_base);?>" class="regular-text code" /></td>
	</tr>
...
<?php wp_nonce_field('update-permalink') ?>
	<p><textarea rows="9" class="large-text readonly" name="rules" id="rules" readonly="readonly"><?=esc_textarea( $wp_rewrite->iis7_url_rewrite_rules() );?></textarea></p>
</form>
...
<form action="options-permalink.php" method="post">
<?php wp_nonce_field('update-permalink') ?>
	<p><textarea rows="18" class="large-text readonly" name="rules" id="rules" readonly="readonly"><?=esc_textarea( $wp_rewrite->iis7_url_rewrite_rules(true) );?></textarea></p>
</form>
...
<form action="options-permalink.php" method="post">
<?php wp_nonce_field('update-permalink') ?>
	<p><textarea rows="6" class="large-text readonly" name="rules" id="rules" readonly="readonly"><?=esc_textarea( $wp_rewrite->mod_rewrite_rules() );?></textarea></p>
</form>
	<?php endif;?>
<?php endif;?>
<?php } // multisite ?>
