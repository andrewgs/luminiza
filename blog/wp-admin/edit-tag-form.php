...
<div class="wrap">
<?php screen_icon();?>
<h2><?=$tax->labels->edit_item;?></h2>
<div id="ajax-response"></div>
<form name="edittag" id="edittag" method="post" action="edit-tags.php" class="validate">
<input type="hidden" name="action" value="editedtag" />
<input type="hidden" name="tag_ID" value="<?=esc_attr($tag->term_id) ?>" />
...
<?php endif; // is_taxonomy_hierarchical() ?>
		<tr class="form-field">
			...
			<td><textarea name="description" id="description" rows="5" cols="50" style="width: 97%;"><?=$tag->description; // textarea_escaped ?></textarea><br />
