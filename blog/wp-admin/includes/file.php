...
<td><input name="hostname" type="text" id="hostname" value="<?=esc_attr($hostname); if ( !empty($port) ) echo ":$port";?>"<?php disabled( defined('FTP_HOST') );?> size="40" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="username"><?=$label_user;?></label></th>
<td><input name="username" type="text" id="username" value="<?=esc_attr($username) ?>"<?php disabled( defined('FTP_USER') );?> size="40" /></td>
</tr>

<tr valign="top">
<th scope="row"><label for="password"><?=$label_pass;?></label></th>
...
<td><br /><input name="public_key" type="text" id="public_key" value="<?=esc_attr($public_key) ?>"<?php disabled( defined('FTP_PUBKEY') );?> size="40" /><br /><input name="private_key" type="text" id="private_key" value="<?=esc_attr($private_key) ?>"<?php disabled( defined('FTP_PRIKEY') );?> size="40" />
...
<?php
	...
	<label for="<?=esc_attr($name) ?>">
		<input type="radio" name="connection_type" id="<?=esc_attr($name) ?>" value="<?=esc_attr($name) ?>"<?php checked($name, $connection_type); echo $disabled;?> />
		<?=$text ?>
	</label>
	<?php endforeach;?>
</fieldset>
