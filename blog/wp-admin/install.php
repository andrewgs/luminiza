...
<form id="setup" method="post" action="install.php?step=2">
	<table class="form-table">
		<tr>
			...
			<td><input name="weblog_title" type="text" id="weblog_title" size="25" value="<?=esc_attr( $weblog_title );?>" /></td>
		</tr>
		<tr>
			...
			if ( $user_table ) {
				...
				?><input name="user_name" type="text" id="user_login" size="25" value="<?=esc_attr( sanitize_user( $user_name, true ) );?>" />
		...
		<tr>
			...
			<td><input name="admin_email" type="text" id="admin_email" size="25" value="<?=esc_attr( $admin_email );?>" />
...
<table class="form-table">
	<tr>
		...
		<td><code><?=esc_html( sanitize_user( $user_name, true ) );?></code></td>
	</tr>
	<tr>
