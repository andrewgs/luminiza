...
?>
	<outline text="<?=esc_attr($title);?>" type="link" xmlUrl="<?=esc_attr($bookmark->link_rss);?>" htmlUrl="<?=esc_attr($bookmark->link_url);?>" updated="<?php if ('0000-00-00 00:00:00' != $bookmark->link_updated) echo $bookmark->link_updated;?>" />
<?php
