...
<h1 id="header"><a href="" title="<?=get_option('blogname');?>"><?=get_option('blogname');?></a></h1>
...
<p><a href="<?=get_post_comments_feed_link($post->ID);?>"><?php _e('<abbr title="Really Simple Syndication">RSS</abbr> feed for comments on this post.');?></a></p>
...
<?php else : ?>
	<p>
	  <input type="text" name="author" id="author" class="textarea" value="<?=esc_attr($comment_author);?>" size="28" tabindex="1" />
	   <label for="author"><?php _e('Name');?></label>
	</p>

	<p>
	  <input type="text" name="email" id="email" value="<?=esc_attr($comment_author_email);?>" size="28" tabindex="2" />
	   <label for="email"><?php _e('E-mail');?></label>
	</p>

	<p>
	  <input type="text" name="url" id="url" value="<?=esc_attr($comment_author_url);?>" size="28" tabindex="3" />
