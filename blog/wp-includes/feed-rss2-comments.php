...
<channel>
	...
	<lastBuildDate><?=mysql2date('r', get_lastcommentmodified('GMT'));?></lastBuildDate>
...
?>
	<item>
		...
		<dc:creator><?=get_comment_author_rss() ?></dc:creator>
		<pubDate><?=mysql2date('D, d M Y H:i:s +0000', get_comment_time('Y-m-d H:i:s', true, false), false);?></pubDate>
		<guid isPermaLink="false"><?php comment_guid() ?></guid>
<?php if ( post_password_required($comment_post) ) : ?>
		<description><?=ent2ncr(__('Protected Comments: Please enter your password to view comments.'));?></description>
