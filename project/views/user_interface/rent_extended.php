				...
				<div class="main_content">
					...
					<?php
						...
						<?php if ($rent['object'] == 'auto'):
								...
								echo form_hidden($data).
								form_error('your_permit').'<div class="clear"></div><label for="your_permit">Номер водительских прав <em class="bright">*</em></label><div class="dd"><input type="text" size="45" maxlength="50" class="y_permit" id="your_permit" value="" name="your_permit"></div><div class="clear"></div>'.form_error('your_pdate').'<div class="clear"></div><label for="your_pdate">Дата получения <em class="bright">*</em></label><div class="dd"><input type="text" size="45" maxlength="50" class="y_pdate" id="your_pdate" value="" name="your_pdate"></div><div class="clear"></div>'.form_error('your_country').'<div class="clear"></div><label for="your_country">Страна получения <em class="bright">*</em></label><div class="dd"><input type="text" size="45" maxlength="50" class="y_country" id="your_country" value="" name="your_country"></div><div class="clear"></div>';
							endif; ?>
						<?=form_error('your_address').'<div class="clear"></div>'; ?>
							...
							<div class="clear"></div>
						<?php if ($rent['object'] == 'auto'):
								echo form_error('your_car').'<div class="clear"></div><label for="your_car">Модель автомобиля <em class="bright">*</em></label><div class="dd"><input type="text" size="45" maxlength="50" class="y_car" id="your_car" value="" name="your_car"></div><div class="clear"></div>';
							endif; ?>
